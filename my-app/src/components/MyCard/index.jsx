...
export default class MyCard extends Component {
  ...
  render() {
    ...
    return (
      <div onClick={this.openNewPage}>
        <Card className="Card" style={{  marginBottom: 10, backgroundColor: 'skyblue' }}>
          <div className="CardNum" style={{ textAlign: 'center' }}>#{listNum}</div>
          <Card.Img className="CardImg" style={{width:'100%'}} variant="top" src={avatar} />
          <Card.Body>
